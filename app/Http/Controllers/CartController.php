...
class CartController extends Controller
{
   public function addCart($id){
       ...
       if($product->discount_price == NULL)
       {
           ...
           Cart::add($data);
           $notification=array(
               'messege'=>'Successfully Added To Your Cart!',
               'alert-type'=>'success'
           );
   ...
   public function showcart(){
    ...
    public function outsidecheckout()
    {
            $cart=Cart::content();
            return view('pages.outsidecheckout',compact('cart'));
    ...
    public function outsidepaymentpage(){
        $cart=Cart::content();
       return view('pages.bkashpayment', compact('cart'));
    }
}
