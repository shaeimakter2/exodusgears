        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-2 order-lg-1 order-2">
                    <ul class="image_list">
                        <li data-image="{{ asset($product->image_one) }}"><img src="{{ asset($product->image_one) }}" style="height: 180px;"></li>
                        <li data-image="{{ asset($product->image_two) }}"><img src="{{ asset($product->image_two) }}"  style="height: 180px;"></li>
                        <li data-image="{{ asset($product->image_three) }}"><img src="{{ asset($product->image_three) }}"  style="height: 180px;"></li>
                    </ul>
                </div>
                        ...
                        <div class="order_info d-flex flex-row">
                            ...
                            <form action="{{ url('cart/product/add/'.$product->id) }}" method="post">
                                    ...
                                    @else
                                        <div class="col-lg-4" >
                                            <div class="form-group">
                                                ...
                                                <select class="form-control input-group-lg" id="exampleFormControlSelect1" name="size">
                                ...
                                @if($product->discount_price == NULL)
                                    <div class="product_price" style="text-align: center"> Price : TK {{ $product->selling_price }}</div>
                                @else
                                @endif
                                @if($product->discount_price != NULL)
                                    <div class="product_price" style="text-align: center">Price: TK {{ $product->discount_price }}</div>
                                @else
                                @endif
                                ...
                                <div class="button_container">
                                    <button type="submit" class="button cart_button btn-block">Add to Cart</button>
