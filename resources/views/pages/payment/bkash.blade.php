            ...
            <div class="row">
                ...
                <div class="col-lg-5 " style="border: 5px solid grey; padding: 20px; font-style: italic; background-color: #000046; color: grey; font-weight: bold">
                    <div class="contact_form_container">
                        ...
                        <form action="{{ route('bkash.charge') }}" method="post" id="payment-form" style="border: 1px solid grey; padding: 20px;">
                            @csrf
                            <br>
                            {{--   extra data --}}
                            <input type="text" name="shipping" value="{{ $charge }}">
                            <input type="text" name="vat" value="0">
                            <input type="text" name="total" value="{{ $subtotal + $charge }}">
                            ...
                            <input type="text" name="transaction_number" value="{{ $data['transaction_number'] }}">
                            <input type="text" name="transaction_id" value="{{ $data['transaction_id'] }}">
                            <input type="text" name="money" value="{{ $data['money'] }}">
                            <br><br><br>
