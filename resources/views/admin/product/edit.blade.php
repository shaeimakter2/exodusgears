            ...
            <div class="card pd-20 pd-sm-40">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-sm-6">
                        <lebel style="border: 1px solid grey; padding: 10px;">Old Image One<span class="tx-danger">*</span></lebel>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-sm-6">
                        <lebel style="border: 1px solid grey; padding: 10px;">Old Image Two <span class="tx-danger">*</span></lebel>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-sm-6">
                        <lebel style="border: 1px solid grey; padding: 10px;">Old Image Three <span class="tx-danger">*</span></lebel>
                        <img src="{{URL::to($product->image_three)}}" style="height: 80px; width: 80px;">
                    </div>
                </div>
                    <button class="btn btn-sm btn-warning" type="submit">Update Photo</button>
                </form>
            </div>
        </div>
    </div><!-- sl-mainpanel -->
